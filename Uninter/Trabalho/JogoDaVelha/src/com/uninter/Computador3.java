...
public class Computador3 extends Jogador { //Classe Computador
	public Scanner entrada = new Scanner(System.in); //Onde vai passar a informação

	public Computador3(int jogador) {// Quando o computador3 for escolhido, essa mensagem vai aparecer
		super(jogador);
		System.out.println("Jogador 'Computador3' criado!");
	}
